...
For **Elasticsearch 2.0** and later, use the major version 2 of the library.
...
The development is happening on ``master`` and ``x.x`` branches, respectively.
...
.. code:: python
    ...
    from elasticsearch2 import Elasticsearch
    from elasticsearch2_dsl import Search, Q
...
.. code:: python
    ...
    from elasticsearch2_dsl import DocType, String, Date, Integer
...
.. code:: python
    ...
    from elasticsearch2_dsl import FacetedSearch
    from elasticsearch2_dsl.aggs import Terms, DateHistogram
